...
<body>
    <div class="page-container">
        ...
        <!-- <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    <button class="btn btn-outline-custom me-2" onclick="exportData()">
                        <i class="fas fa-download me-2"></i>Export
                    </button>
                    <button class="btn btn-primary-custom" onclick="showImportModal()">
        ...
        <div class="tab-content" id="managementTabContent">
                ...
                <div class="management-card">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h3 class="section-title mb-0">
                            <i class="fas fa-tags text-primary"></i>Fashion Categories
                        </h3>
            ...
            <div class="tab-pane fade" id="products" role="tabpanel">
                <div class="management-card">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h3 class="section-title mb-0">
                            <i class="fas fa-tshirt text-success"></i>Fashion Products
                        </h3>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <form method="POST" enctype="multipart/form-data" id="addProductForm">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-outline-custom" data-bs-dismiss="modal"><i class="fas fa-times me-2"></i>Cancel</button>
                        <button type="submit" class="btn btn-primary-custom" name="save_product"><i class="fas fa-save me-2"></i>Save Product</button>
                    </div>
                </form>
            </div>
        </div>
