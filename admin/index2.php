...
<head>
    ...
    <style>
        ...
        * {
        ...
        .dashboard-content .stats-row > [class*="col"] {
            padding: 0 10px;
        }
            ...
            <div class="col-md-3 col-lg-2 px-0">
                <div class="sidebar">
                    ...
                    <nav class="nav flex-column px-2">
                        ...
                        <a class="nav-link" href="#" onclick="loadPage('sizes-colors', event)">
                            <i class="fas fa-palette"></i> Sizes & Colors
                        </a>
                        <a class="nav-link" href="#" onclick="loadPage('orders', event)">
                            <i class="fas fa-shopping-cart"></i> Orders
                        </a>
                        <a class="nav-link" href="#" onclick="loadPage('customers', event)">
                            <i class="fas fa-users"></i> Customers
                        </a>
                        <a class="nav-link" href="#" onclick="loadPage('enquiry', event)">
                            <i class="fas fa-envelope"></i> Enquiries
                        </a>
                        <a class="nav-link" href="#" onclick="loadPage('reviews', event)">
                            <i class="fas fa-star"></i> Reviews
                        </a>
                        <a class="nav-link" href="#" onclick="loadPage('coupons', event)">
                            <i class="fas fa-ticket-alt"></i> Coupons
                        </a>
                        <a class="nav-link" href="#" onclick="loadPage('reports', event)">
                            ...
                            <div class="row stats-row">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    <div class="stats-card card-success" style="--animation-order: 0">
                                        <a href="#" class="card-link" onclick="loadPage('inventory', event)">View All</a>
                                        <div class="card-icon">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    <div class="stats-card card-purple" style="--animation-order: 1">
                                        <a href="#" class="card-link" onclick="loadPage('customers', event)">View All</a>
                                        <div class="card-icon">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    <div class="stats-card card-warning" style="--animation-order: 2">
                                        <a href="#" class="card-link" onclick="loadPage('inventory', event)">Restock</a>
                                        <div class="card-icon">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    <div class="stats-card card-danger" style="--animation-order: 3">
                                        <a href="#" class="card-link" onclick="loadPage('orders', event)">Process</a>
                                        <div class="card-icon">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    <div class="stats-card card-warning" style="--animation-order: 8">
                                        <a href="#" class="card-link" onclick="loadPage('reviews', event)">View All</a>
                                        <div class="card-icon">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    <div class="stats-card card-purple" style="--animation-order: 9">
                                        <a href="#" class="card-link" onclick="loadPage('coupons', event)">View All</a>
                                        <div class="card-icon">
